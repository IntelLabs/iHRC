...
#else
                if(g_video->updating) graphics.DrawImage(g_pBitmap, (int)ps.rcPaint.left, (int)ps.rcPaint.top, (int)ps.rcPaint.left, (int)ps.rcPaint.top,
                                    (int)ps.rcPaint.right, (int)ps.rcPaint.bottom, Gdiplus::UnitPixel);
#endif
                EndPaint(hwnd, &ps);
            }
