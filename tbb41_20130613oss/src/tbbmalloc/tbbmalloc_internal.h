...
//#ifdef SVM
//#define SVM_SIZE (1UL << 28)
#define SVM_SIZE (392167424)
// BTL 20101129 The next available and limit pointers for the simple bump-pointer 
// svmRegion allocator used to get raw memory (pages) from the "OS". 
extern void *nextSVMAvailable;
extern void *svmRegionLimit;

// The OS allocation granularity for getRawMemory/rawAlloc.
extern unsigned allocationGranularity;
